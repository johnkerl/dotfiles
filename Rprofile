...
etrc <- function() {
  spdl::filesetup("/dev/stderr")
  spdl::set_level("trace")
}
edbg <- function() {
  spdl::filesetup("/dev/stderr")
...
tfac <- function() {
  testthat::test_file("tests/testthat/test-Factory.R")
}
# tsdf  <- function() { testthat::test_file("tests/testthat/test-SOMADataFrame.R") }
tsdf <- function() {
  devtools::test_active_file(file = "tests/testthat/test-SOMADataFrame.R")
}
tsnda <- function() {
  devtools::test_active_file(file = "tests/testthat/test-SOMASparseNDArray.R")
}
tsh <- function() {
  devtools::test_active_file(file = "tests/testthat/test-shape.R")
}
tseq <- function() {
  testthat::test_file("tests/testthat/test-SOMAExperiment-query.R")
}
tsceo <- function() {
  testthat::test_file("tests/testthat/test-SCEOutgest.R")
}

tht1 <- function(filename) {
  devtools::test_active_file(file = filename)
}
...
tcurg <- function() {
  tinytest::run_test_file("inst/tinytest/test_c_udf_reg_generic.R")
}
tcue <- function() {
  tinytest::run_test_file("inst/tinytest/test_c_udf_execution.R")
}
ttd1 <- function() {
  tinytest::run_test_file("inst/tinytest/test_a_delayed_1.R")
}
ttd2 <- function() {
  tinytest::run_test_file("inst/tinytest/test_a_delayed_2.R")
}
ttd3 <- function() {
  tinytest::run_test_file("inst/tinytest/test_a_delayed_3.R")
}
ttd4 <- function() {
  tinytest::run_test_file("inst/tinytest/test_a_delayed_4.R")
}
ttd5 <- function() {
  tinytest::run_test_file("inst/tinytest/test_d_delayed_5.R")
}
ttd6 <- function() {
  tinytest::run_test_file("inst/tinytest/test_d_delayed_6.R")
}
ttd7 <- function() {
  tinytest::run_test_file("inst/tinytest/test_d_delayed_7.R")
}
ttdr <- function() {
